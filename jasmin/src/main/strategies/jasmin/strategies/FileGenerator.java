...
public class FileGenerator {
    ...
    public byte[] generateClass(Context context, IStrategoTerm header, IStrategoTerm fields, IStrategoTerm methods) {
    ...
    public void visitFields(ClassWriter cw, Context context, IStrategoTerm fields) {
    ...
    public void visitField(ClassWriter cw, Context context, IStrategoTerm field) {
    ...
    private void visitField(ClassWriter cw, Context context, IStrategoTerm flags, IStrategoTerm nameTerm,
        IStrategoTerm descTerm, IStrategoTerm sigTerm, IStrategoTerm initial) {
        int access = 0;
        String name = "";
        String descr = "";
        String sig = null;
